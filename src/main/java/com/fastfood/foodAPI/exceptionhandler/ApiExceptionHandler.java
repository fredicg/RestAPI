...
import com.fastfood.foodAPI.core.validation.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public static final String MSG_ERRO_USUARIO_FINAL = "Ocorreu um erro interno inesperado no sistema. "
	...
	public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
		...
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage("Um ou mais campos obrigátórios não foram preenchidos").build();
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String detail = "O corpo da requisação está inválido. Verifique erro de sintaxe. ";
	...
	public ResponseEntity<?> handleEntidadeNaoEncontradaException(EntidadeNaoEncontradaException ex, WebRequest request){
		 ...
		 * .type("https://food-api.com/entidade-nao-encontrada")
	...
	public ResponseEntity<?> handleConflictception(EntidadeEmUsoException ex, WebRequest request){
